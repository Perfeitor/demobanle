...
public partial class DATAContext : DbContext
{
    ...
    public virtual DbSet<CaidatForm> CaidatForms { get; set; }

    public virtual DbSet<Canhbaomaxmin> Canhbaomaxmins { get; set; }
    ...
    public virtual DbSet<Ctugocbk> Ctugocbks { get; set; }
    ...
    public virtual DbSet<Dmdoiqua> Dmdoiquas { get; set; }
    ...
    public virtual DbSet<Dmptnxbk> Dmptnxbks { get; set; }
    ...
    public virtual DbSet<Giaodichctnguyenlieu> Giaodichctnguyenlieus { get; set; }
    ...
    public virtual DbSet<Giaodichquaydodang> Giaodichquaydodangs { get; set; }

    public virtual DbSet<Giaodichquaydodangct> Giaodichquaydodangcts { get; set; }

    public virtual DbSet<Giaodichquayf3ct> Giaodichquayf3cts { get; set; }

    public virtual DbSet<Giaodichtichdiem> Giaodichtichdiems { get; set; }
    ...
    public virtual DbSet<Giaodichxuathoadon> Giaodichxuathoadons { get; set; }

    public virtual DbSet<Giavon> Giavons { get; set; }
    ...
    public virtual DbSet<KhohangChungtu> KhohangChungtus { get; set; }

    public virtual DbSet<Khohanggium> Khohanggia { get; set; }

    public virtual DbSet<Khohangtichdiem> Khohangtichdiems { get; set; }
    ...
    public virtual DbSet<LichDathangtheothu> LichDathangtheothus { get; set; }

    public virtual DbSet<Lichsugiaodichgopdon> Lichsugiaodichgopdons { get; set; }

    public virtual DbSet<Lichsusuagiaban> Lichsusuagiabans { get; set; }

    public virtual DbSet<Lichthanhtoan> Lichthanhtoans { get; set; }
    ...
    public virtual DbSet<Mathangshowweb> Mathangshowwebs { get; set; }

    public virtual DbSet<Mathangthue> Mathangthues { get; set; }
    ...
    public virtual DbSet<NguoidungKhohang> NguoidungKhohangs { get; set; }
    ...
    public virtual DbSet<Nhomhangphu> Nhomhangphus { get; set; }
    ...
    public virtual DbSet<Sodudaukybk> Sodudaukybks { get; set; }

    public virtual DbSet<Sodudaukybk2020> Sodudaukybk2020s { get; set; }
    ...
    public virtual DbSet<VtLichdixe> VtLichdixes { get; set; }
    ...
    public virtual DbSet<Xnt13062020> Xnt13062020s { get; set; }

    public virtual DbSet<Xnt14062020> Xnt14062020s { get; set; }

    public virtual DbSet<Xnt15062020> Xnt15062020s { get; set; }

    public virtual DbSet<Xnt16062020> Xnt16062020s { get; set; }

    public virtual DbSet<XntGiavondk> XntGiavondks { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=113.160.45.110,1432;Database=DEMOBANLE;Persist Security Info=True;User ID=sa;Password=1106@ety#ks29x;Trusted_Connection=False;TrustServerCertificate=True;Connection Timeout = 30;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Bangkethuegtgt>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Mabangke }).HasName("PK_Bangkethuegtgt_1");
        ...
        modelBuilder.Entity<Baogiact>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Baogiacts)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Baogiact_Donvi");

            entity.HasOne(d => d.Baogium).WithMany(p => p.Baogiacts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Baogiact_Baogia");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Baogiacts)
        ...
        modelBuilder.Entity<Baogium>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Baogia)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Barcode1, e.Madonvi }).HasName("PK_Barcode_1");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Barcodes)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Bohang>(entity =>
        {
            ...
            entity.Property(e => e.Tenbo).HasMaxLength(200);
            entity.Property(e => e.Tendangnhap)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tendangnhapsua)
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Bohangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Bohangct>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Bohangcts)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Bohangct_Donvi");

            entity.HasOne(d => d.Bohang).WithMany(p => p.Bohangcts)
                .HasForeignKey(d => new { d.Mabohang, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Bohangct_Bohang");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Bohangcts)
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Bohangct_Mathang");
        });

        modelBuilder.Entity<CaidatForm>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Danhmuc, e.Madoituong });

            entity.ToTable("CaidatForm");
        ...
        modelBuilder.Entity<Canhbaomaxmin>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Makhohang, e.Masieuthi });

            entity.ToTable("Canhbaomaxmin");
        ...
        modelBuilder.Entity<Checkgiaodichquayct>(entity =>
        {
            ...
            entity.Property(e => e.Tensieuthi).HasMaxLength(300);
            entity.Property(e => e.Thanhtien).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienck).HasColumnType("decimal(20, 8)");
        });
        ...
        modelBuilder.Entity<Ctugocbk>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Ctugocbk");
        ...
        modelBuilder.Entity<Dathang>(entity =>
        {
            ...
            entity.Property(e => e.Ngaytao)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.Nguoinhanhang).HasMaxLength(500);
            entity.Property(e => e.Tendangnhap)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tendangnhapsua)
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Dathangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dathang_Donvi");

            entity.HasOne(d => d.Dmptnx).WithMany(p => p.Dathangs)
        ...
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Masieuthi, e.Madonvi });
            ...
            entity.Property(e => e.Thanhtien).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienck).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienckkm).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienhang).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienvat).HasColumnType("decimal(20, 8)");
            ...
            entity.Property(e => e.Tyleck).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tyleckkm).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Xuattkgt).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Xuattksl).HasColumnType("decimal(20, 8)");

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Dathangcts)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dathangct_Donvi");

            entity.HasOne(d => d.Dathang).WithMany(p => p.Dathangcts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dathangct_Dathang");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Dathangcts)
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Denghithanhtoan>(entity =>
        {
            ...
            entity.Property(e => e.Makhachang)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Maloaichungtu)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Maloaitien)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Nganhang).HasMaxLength(500);
            entity.Property(e => e.Ngayphatsinh).HasColumnType("datetime");
            entity.Property(e => e.Ngaytao).HasColumnType("datetime");
            ...
            entity.Property(e => e.Sotaikhoan)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Thoihanthanhtoan).HasMaxLength(200);
            entity.Property(e => e.Tygia).HasColumnType("decimal(20, 8)");
        });

        modelBuilder.Entity<Denghithanhtoanct>(entity =>
        {
            entity.HasKey(e => new { e.Madenghi, e.Madonvi, e.Magiaodichpk });
        ...
        modelBuilder.Entity<DmCachdonggoi>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tendonggoi).HasMaxLength(250);
        });
        ...
        modelBuilder.Entity<DmCongtrinh>(entity =>
        {
            ...
            entity.HasOne(d => d.DmLoaicongtrinh).WithMany(p => p.DmCongtrinhs)
        ...
        {
            entity.HasKey(e => new { e.Madonvi, e.Mahaiquan }).HasName("PK_DmMahaiquan_1");
            ...
            entity.Property(e => e.Mahaiquan)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Giabuonchuavat).HasColumnType("decimal(18, 7)");
            ...
            entity.Property(e => e.Quydoi).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tendaydu).HasMaxLength(500);
            entity.Property(e => e.Tenrutgon).HasMaxLength(250);
        });
        ...
        modelBuilder.Entity<DmVanchuyen>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tenvanchuyen).HasMaxLength(250);
        });
        ...
        modelBuilder.Entity<Dmchinhanhnganhang>(entity =>
        {
            ...
            entity.HasOne(d => d.ManganhangNavigation).WithMany(p => p.Dmchinhanhnganhangs)
        ...
        {
            entity.HasKey(e => new { e.Mactu, e.Madonvi }).HasName("PK_TDS_Dmchungtu");
            ...
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Kyhieuct).HasMaxLength(20);
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Dmchungtus)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dmchungtu_Donvi");

            entity.HasOne(d => d.MaloaictuNavigation).WithMany(p => p.Dmchungtus)
                .HasForeignKey(d => d.Maloaictu)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dmchungtu_Dmloaichungtu");
        });

        modelBuilder.Entity<Dmdoiqua>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Masieuthi });

            entity.ToTable("Dmdoiqua");
            ...
            entity.Property(e => e.Masieuthi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Diem).HasColumnType("decimal(18, 7)");
        });

        modelBuilder.Entity<Dmloaichungtu>(entity =>
        {
            entity.HasKey(e => e.Maloaictu).HasName("PK_TDS_Dmloaichungtu");
        ...
        {
            entity.HasKey(e => e.Maloaitk).HasName("PK_TDS_Dmloaitk");
        ...
        {
            entity.HasKey(e => e.Manhomptnx).HasName("PK_TDS_Dmnhomptnx");
        ...
        modelBuilder.Entity<Dmptnx>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Dmptnxes)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dmptnx_Donvi");

            entity.HasOne(d => d.ManhomptnxNavigation).WithMany(p => p.Dmptnxes)
                .HasForeignKey(d => d.Manhomptnx)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dmptnx_Dmnhomptnx");
        });

        modelBuilder.Entity<Dmptnxbk>(entity =>
        {
            entity.HasKey(e => new { e.Maptnx, e.Madonvi });

            entity.ToTable("Dmptnxbk");
        ...
        modelBuilder.Entity<Dmtieuchuan>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tentieuchuan).HasMaxLength(250);
        });
        ...
        modelBuilder.Entity<Dmtk>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Dmtks)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dmtk_Donvi");

            entity.HasOne(d => d.MaloaitkNavigation).WithMany(p => p.Dmtks)
        ...
        modelBuilder.Entity<Dmtknganhang>(entity =>
        {
            ...
            entity.Property(e => e.Dienthoai)
                ...
                .IsUnicode(false);
            entity.Property(e => e.Email).HasMaxLength(100);
            entity.Property(e => e.Machinhanh).HasMaxLength(20);
            entity.Property(e => e.Manganhang).HasMaxLength(20);
        ...
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Madonvi }).HasName("PK_SxDondat");
        ...
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Madonvi, e.Masieuthi }).HasName("PK_SxDondatct");
            ...
            entity.HasOne(d => d.Dondat).WithMany(p => p.Dondatcts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SxDondatct_SxDondatct");
        });
        ...
        modelBuilder.Entity<Donvi>(entity =>
        {
            ...
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Chutaikhoan).HasMaxLength(250);
            entity.Property(e => e.Diachi).HasMaxLength(200);
            entity.Property(e => e.Dienthoai)
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.Mausohoadon)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Nganhang).HasMaxLength(250);
        ...
        modelBuilder.Entity<Donvitinh>(entity =>
        {
            ...
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Donvile).HasMaxLength(50);
            entity.Property(e => e.Donvilon).HasMaxLength(50);
            entity.Property(e => e.Ngaytao)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.Tendangnhap)
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Donvitinhs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Donvitinh_Donvi");

            entity.HasOne(d => d.Nguoidung).WithMany(p => p.Donvitinhs)
        ...
        {
            entity.HasKey(e => new { e.Madonvi, e.Madutoan, e.Mahangmuc, e.Masieuthi });
            ...
            entity.HasOne(d => d.Dutoan).WithMany(p => p.Dutoancts)
        ...
        modelBuilder.Entity<Giaodich>(entity =>
        {
            ...
            entity.HasOne(d => d.Dmptnx).WithMany(p => p.Giaodiches)
                .HasForeignKey(d => new { d.Maptnx, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<GiaodichLinkQuy>(entity =>
        {
            ...
            entity.Property(e => e.Matk)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Sotienthanhtoan).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Sotienthanhtoannt).HasColumnType("decimal(20, 8)");
        });
        ...
        modelBuilder.Entity<Giaodichct>(entity =>
        {
            ...
            entity.HasOne(d => d.Giaodich).WithMany()
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichct_Giaodich");

            entity.HasOne(d => d.Mathang).WithMany()
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Giaodichctkhuyenmai>(entity =>
        {
            ...
            entity.Property(e => e.Magiaodichpk)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Masieuthi).HasMaxLength(20);
            entity.Property(e => e.Soluongkm).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienkm).HasColumnType("decimal(20, 8)");
        });

        modelBuilder.Entity<Giaodichctnguyenlieu>(entity =>
        {
            entity.ToTable("Giaodichctnguyenlieu");
        ...
        modelBuilder.Entity<Giaodichgiaonhanct>(entity =>
        {
            ...
            entity.HasOne(d => d.Giaodichgiaonhan).WithMany(p => p.Giaodichgiaonhancts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Giaodichquay>(entity =>
        {
            ...
            entity.Property(e => e.Tienmat)
                .HasDefaultValue(0m)
                .HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienqrcode).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienthe)
                .HasDefaultValue(0m)
                .HasColumnType("decimal(20, 8)");

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Giaodichquays)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquay_Donvi");

            entity.HasOne(d => d.Dmptnx).WithMany(p => p.Giaodichquays)
                .HasForeignKey(d => new { d.Maptnx, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Giaodichquayct>(entity =>
        {
            ...
            entity.HasOne(d => d.Giaodichquay).WithMany(p => p.Giaodichquaycts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquayct_Giaodichquay");

            entity.HasOne(d => d.Khohang).WithMany(p => p.Giaodichquaycts)
                .HasForeignKey(d => new { d.Makhohang, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquayct_Khohang");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Giaodichquaycts)
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquayct_Mathang");
        });

        modelBuilder.Entity<Giaodichquaydodang>(entity =>
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Madonvi });

            entity.ToTable("Giaodichquaydodang");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Giaodichquaydodangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquaydodang_Donvi");

            entity.HasOne(d => d.Dmptnx).WithMany(p => p.Giaodichquaydodangs)
                .HasForeignKey(d => new { d.Maptnx, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquaydodang_Dmptnx");
        });

        modelBuilder.Entity<Giaodichquaydodangct>(entity =>
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Madonvi, e.Masieuthi, e.Mabohang, e.Makhohang });

            entity.ToTable("Giaodichquaydodangct");
            ...
            entity.HasOne(d => d.Giaodichquaydodang).WithMany(p => p.Giaodichquaydodangcts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquaydodangct_Giaodichquaydodang");

            entity.HasOne(d => d.Khohang).WithMany(p => p.Giaodichquaydodangcts)
                .HasForeignKey(d => new { d.Makhohang, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquaydodangct_Khohang");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Giaodichquaydodangcts)
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Giaodichquaydodangct_Mathang");
        });

        modelBuilder.Entity<Giaodichquayf3ct>(entity =>
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Madonvi, e.Masieuthi, e.Mabohang, e.Makhohang });

            entity.ToTable("Giaodichquayf3ct");
        ...
        modelBuilder.Entity<Giaodichtichdiem>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_Giaodichtichdiem_1");

            entity.ToTable("Giaodichtichdiem");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Diemdadoi).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Diemtichluy).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Diemtralai).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Doanhsoban).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Magiaodichpk)
            ...
            entity.Property(e => e.Ngaytao)
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.Tiendoidiem).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tientralai).HasColumnType("decimal(20, 8)");
        });
        ...
        modelBuilder.Entity<Giaodichxuathoadon>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Giaodichxuathoadon");
            ...
            entity.Property(e => e.Nguoimuahang).HasMaxLength(100);
        });

        modelBuilder.Entity<Giavon>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Giavon");

            entity.Property(e => e.Giavon1)
            ...
            entity.Property(e => e.Thanhtien).HasColumnType("decimal(18, 7)");
        });
        ...
        modelBuilder.Entity<Khachhang>(entity =>
        {
            ...
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Chutaikhoan).HasMaxLength(50);
            ...
            entity.Property(e => e.Tongdiem).HasColumnType("decimal(20, 8)");

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Khachhangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Keys).HasName("PK_Khachhanggia_1");
        ...
        modelBuilder.Entity<Khohang>(entity =>
        {
            ...
            entity.Property(e => e.Dienthoai)
                ...
                .IsUnicode(false);
            entity.Property(e => e.Ghichu).HasMaxLength(200);
            entity.Property(e => e.HienthiQr).HasColumnName("HienthiQR");
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tenhienthihoadon).HasMaxLength(250);
            entity.Property(e => e.Tenkhohang).HasMaxLength(250);
            entity.Property(e => e.Tentaikhoan)
                .HasMaxLength(200)
                .IsUnicode(false);

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Khohangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Khohang_Donvi");
        });

        modelBuilder.Entity<KhohangChungtu>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Makhohang, e.Ma, e.Loai });

            entity.ToTable("KhohangChungtu");
        ...
        {
            entity.HasKey(e => new { e.Makhohang, e.Maloaigia, e.Maapdung, e.Madonvi }).HasName("PK_Khohanggia_1");
            ...
            entity.Property(e => e.Tilelaibuon).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tilelaile).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tyleck).HasColumnType("decimal(20, 8)");
        });

        modelBuilder.Entity<Khohangtichdiem>(entity =>
        {
            entity.HasKey(e => new { e.Makhohang, e.Madonvi });

            entity.ToTable("Khohangtichdiem");
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tienquydoi).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Tienquydoidiem).HasColumnType("decimal(20, 8)");
        });
        ...
        modelBuilder.Entity<Khuyenmai>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Khuyenmais)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Khuyenmaict>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Khuyenmaicts)
                .HasForeignKey(d => d.Madonvi)
                .HasConstraintName("FK_Khuyenmaict_Donvi");

            entity.HasOne(d => d.Khuyenmai).WithMany(p => p.Khuyenmaicts)
        ...
        {
            entity.HasKey(e => new { e.Masieuthi, e.Madonvi }).HasName("PK_Khichthuocsp");
            ...
            entity.HasOne(d => d.Mathang).WithOne(p => p.Kichthuocsp)
        ...
        modelBuilder.Entity<Kiemke>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Kiemkes)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Kiemkect>(entity =>
        {
            ...
            entity.HasOne(d => d.Kiemke).WithMany(p => p.Kiemkects)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Kiemkect_Kiemke");

            entity.HasOne(d => d.Nganhhang).WithMany(p => p.Kiemkects)
                .HasForeignKey(d => new { d.Manganh, d.Madonvi })
                .HasConstraintName("FK_Kiemkect_Nganhhang");

            entity.HasOne(d => d.Nhomhang).WithMany(p => p.Kiemkects)
                .HasForeignKey(d => new { d.Manhomhang, d.Madonvi })
                .HasConstraintName("FK_Kiemkect_Nhomhang");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Kiemkects)
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Makmchiphi, e.Madonvi }).HasName("PK_TDS_Kmchiphi");
            ...
            entity.Property(e => e.Tendangnhap)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tenkmchiphi).HasMaxLength(250);

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Kmchiphis)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Kmchiphi_Donvi");

            entity.HasOne(d => d.Nhomkmchiphi).WithMany(p => p.Kmchiphis)
        ...
        modelBuilder.Entity<LichDathangtheothu>(entity =>
        {
            entity.HasKey(e => e.ItemId);

            entity.ToTable("LichDathangtheothu");
        ...
        modelBuilder.Entity<Lichsusuagiaban>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Lichsusuagiaban");

            entity.Property(e => e.Formname)
                .HasMaxLength(30)
                .IsUnicode(false);
            entity.Property(e => e.Giabancu).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Giabanmoi).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Giamuacu).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Giamuamoi).HasColumnType("decimal(20, 8)");
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Magiaodichpk)
        ...
        modelBuilder.Entity<Lichthanhtoan>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Lichthanhtoan");

            entity.Property(e => e.Lichthanhtoan1)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("Lichthanhtoan");
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Makhachhang)
        ...
        modelBuilder.Entity<Loaikhachhang>(entity =>
        {
            ...
            entity.Property(e => e.Tenloaikhachang).HasMaxLength(50);
        });
        ...
        {
            entity.HasKey(e => new { e.Masieuthi, e.Madonvi, e.Itemcode }).HasName("PK_Macandt");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Macandientus)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Macandientu_Donvi");

            entity.HasOne(d => d.Mathang).WithMany(p => p.Macandientus)
                .HasForeignKey(d => new { d.Masieuthi, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MartLog>(entity =>
        {
            ...
            entity.Property(e => e.Malog)
                ...
                .IsUnicode(false);
            entity.Property(e => e.Ngaytao).HasColumnType("datetime");
            entity.Property(e => e.Nguoitao).HasMaxLength(200);
            entity.Property(e => e.Tenform).HasMaxLength(200);
        ...
        modelBuilder.Entity<Mathang>(entity =>
        {
            ...
            entity.Property(e => e.Makhachhang)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Mamathangthue)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Manganh)
                .HasMaxLength(20)
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Mathangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathang_Donvi");

            entity.HasOne(d => d.Donvitinh).WithMany(p => p.Mathangs)
                .HasForeignKey(d => new { d.Madvtinh, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathang_Donvitinh");

            entity.HasOne(d => d.Nganhhang).WithMany(p => p.Mathangs)
                .HasForeignKey(d => new { d.Manganh, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathang_Nganhhang");

            entity.HasOne(d => d.Nhomhang).WithMany(p => p.Mathangs)
                .HasForeignKey(d => new { d.Manhomhang, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Mathangshowweb>(entity =>
        {
            entity.HasKey(e => new { e.Masieuthi, e.Madonvi });

            entity.ToTable("Mathangshowweb");
        ...
        modelBuilder.Entity<Mathangthue>(entity =>
        {
            entity.HasKey(e => new { e.Masieuthi, e.Madonvi });

            entity.ToTable("Mathangthue");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Mathangthues)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathangthue_Donvi");

            entity.HasOne(d => d.Donvitinh).WithMany(p => p.Mathangthues)
                .HasForeignKey(d => new { d.Madvtinh, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathangthue_Donvitinh");

            entity.HasOne(d => d.Nganhhang).WithMany(p => p.Mathangthues)
                .HasForeignKey(d => new { d.Manganh, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathangthue_Nganhhang");

            entity.HasOne(d => d.Nhomhang).WithMany(p => p.Mathangthues)
                .HasForeignKey(d => new { d.Manhomhang, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mathangthue_Nhomhang");
        });
        ...
        modelBuilder.Entity<Menunhomquyen>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Menunhomquyens)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Menunhomquyen_Donvi");

            entity.HasOne(d => d.Nhomquyen).WithMany(p => p.Menunhomquyens)
        ...
        modelBuilder.Entity<Nganhhang>(entity =>
        {
            ...
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Loai).HasDefaultValue(10);
            entity.Property(e => e.Ngaytao)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.Tendangnhap)
            ...
            entity.Property(e => e.Trongsodathang).HasColumnType("decimal(20, 8)");

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Nganhhangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Nguoidung>(entity =>
        {
            ...
            entity.Property(e => e.Hovaten).HasMaxLength(150);
            entity.Property(e => e.Makhohang)
                .HasMaxLength(20)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<NguoidungKhohang>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Tendangnhap, e.Makhohang });

            entity.ToTable("NguoidungKhohang");
        ...
        modelBuilder.Entity<Nhomhang>(entity =>
        {
            ...
            entity.Property(e => e.Tylecpvc).HasColumnType("decimal(20, 8)");

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Nhomhangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Nhomhang_Donvi");

            entity.HasOne(d => d.Nguoidung).WithMany(p => p.Nhomhangs)
                .HasForeignKey(d => new { d.Madonvi, d.Tendangnhap })
                .HasConstraintName("FK_Nhomhang_Nguoidung");

            entity.HasOne(d => d.Nganhhang).WithMany(p => p.Nhomhangs)
                .HasForeignKey(d => new { d.Manganh, d.Madonvi })
                .HasConstraintName("FK_Nhomhang_Nganhhang");
        });

        modelBuilder.Entity<Nhomhangphu>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Nhomhangphu");
            ...
            entity.Property(e => e.Manhomphu)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Tennhomphu).HasMaxLength(100);
        });
        ...
        modelBuilder.Entity<Nhomkhachhang>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tennhomkhachhang).HasMaxLength(250);
            entity.Property(e => e.Tilechietkhau)
                .HasDefaultValue(0m)
                .HasColumnType("decimal(18, 0)");

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Nhomkhachhangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Nhomkmchiphi>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhap)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tennhomkmchiphi).HasMaxLength(250);

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Nhomkmchiphis)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Nhomquyen>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tennhomquyen).HasMaxLength(150);

            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Nhomquyens)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Nhomquyenphu>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Nhomquyenphus)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Nhomquyenphu_Donvi");

            entity.HasOne(d => d.Nhomquyen).WithMany(p => p.Nhomquyenphus)
                .HasForeignKey(d => new { d.Manhomquyen, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Nhomvuviec>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhap)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tennhomvuviec).HasMaxLength(250);
        });
        ...
        modelBuilder.Entity<NsBangchamcong>(entity =>
        {
            ...
            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsBangchamcongs)
        ...
        modelBuilder.Entity<NsBangchamcongct>(entity =>
        {
            ...
            entity.HasOne(d => d.NsBangchamcong).WithMany()
        ...
        modelBuilder.Entity<NsBangluong>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsBangluongs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsBangluong_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsBangluongs)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .HasConstraintName("FK_NsBangluong_NsBophan");

            entity.HasOne(d => d.NsPhongban).WithMany(p => p.NsBangluongs)
        ...
        modelBuilder.Entity<NsBangluongct>(entity =>
        {
            ...
            entity.HasOne(d => d.NsBangluong).WithMany()
        ...
        modelBuilder.Entity<NsBangluongphat>(entity =>
        {
            ...
            entity.HasOne(d => d.NsKhenthuongkyluat).WithMany()
        ...
        modelBuilder.Entity<NsBangluongphucap>(entity =>
        {
            ...
            entity.HasOne(d => d.NsPhucap).WithMany()
        ...
        {
            entity.HasKey(e => new { e.Mabaohiem, e.Madonvi }).HasName("PK_Nsbaohiem");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsBaohiems)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Mabaohiem, e.Manhanvien, e.Madonvi }).HasName("PK_NsBaohiemnhanvien_1");
            ...
            entity.HasOne(d => d.NsBaohiem).WithMany(p => p.NsBaohiemnhanviens)
                .HasForeignKey(d => new { d.Mabaohiem, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsBaohiemnhanvien_NsBaohiem");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsBaohiemnhanviens)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Mabophan, e.Madonvi }).HasName("PK_Nsbophan");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsBophans)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsBophan_Donvi");

            entity.HasOne(d => d.NsPhongban).WithMany(p => p.NsBophans)
                .HasForeignKey(d => new { d.Maphongban, d.Madonvi })
        ...
        {
            entity.HasKey(e => new { e.Macalamviec, e.Madonvi }).HasName("PK_Nscalamviec");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsCalamviecs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Machucvu, e.Madonvi }).HasName("PK_Nschucvu");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsChucvus)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<NsChuyenbophan>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsChuyenbophans)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsChuyenbophan_NsChuyenbophan");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsChuyenbophans)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .HasConstraintName("FK_NsChuyenbophan_NsBophan");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsChuyenbophans)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
        ...
        {
            entity.HasKey(e => new { e.Macongthuc, e.Madonvi }).HasName("PK_NsCongthuctinhluong_1");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsCongthuctinhluongs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsCongthuctinhluong_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsCongthuctinhluongs)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .HasConstraintName("FK_NsCongthuctinhluong_NsBophan");

            entity.HasOne(d => d.NsPhongban).WithMany(p => p.NsCongthuctinhluongs)
                .HasForeignKey(d => new { d.Maphongban, d.Madonvi })
        ...
        {
            entity.HasKey(e => new { e.Madangkylamthem, e.Madonvi }).HasName("PK_Nsdangkylamthem");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsDangkylamthems)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsDangkylamthem_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsDangkylamthems)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .HasConstraintName("FK_NsDangkylamthem_NsBophan");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsDangkylamthems)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
        ...
        modelBuilder.Entity<NsDangkylamthemct>(entity =>
        {
            ...
            entity.HasOne(d => d.NsDangkylamthem).WithMany()
        ...
        {
            entity.HasKey(e => new { e.Madangkynghi, e.Madonvi }).HasName("PK_Nsdangkynghi");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsDangkynghis)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsDangkynghi_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsDangkynghis)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .HasConstraintName("FK_NsDangkynghi_NsBophan");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsDangkynghis)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
        ...
        modelBuilder.Entity<NsDangkynghict>(entity =>
        {
            ...
            entity.HasOne(d => d.NsDangkynghi).WithMany()
        ...
        modelBuilder.Entity<NsDinhmucluong>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsDinhmucluongs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsDinhmucluong_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsDinhmucluongs)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .HasConstraintName("FK_NsDinhmucluong_NsBophan");

            entity.HasOne(d => d.NsPhongban).WithMany(p => p.NsDinhmucluongs)
                .HasForeignKey(d => new { d.Maphongban, d.Madonvi })
        ...
        {
            entity.HasKey(e => new { e.Maganlichlamviec, e.Madonvi }).HasName("PK_Nsganlichlamviec");
            ...
            entity.HasOne(d => d.NsLichlamviec).WithMany(p => p.NsGanlichlamviecs)
                .HasForeignKey(d => new { d.Malichlamviec, d.Madonvi })
                .HasConstraintName("FK_NsGanlichlamviec_NsLichlamviec");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsGanlichlamviecs)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
        ...
        modelBuilder.Entity<NsKhenthuongkyluat>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsKhenthuongkyluats)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Malichlamviec, e.Madonvi }).HasName("PK_Nslichlamviec");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsLichlamviecs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maphongban, e.Madonvi }).HasName("PK_NsLichlamvieccasangchieu_1");
            ...
            entity.HasOne(d => d.NsPhongban).WithOne(p => p.NsLichlamvieccasangchieu)
        ...
        modelBuilder.Entity<NsLichlamviecctthang>(entity =>
        {
            ...
            entity.HasOne(d => d.NsLichlamviecthang).WithMany()
        ...
        {
            entity.HasKey(e => new { e.Malichlamviecthang, e.Madonvi }).HasName("PK_NsLichlamviecthang_1");
            ...
            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsLichlamviecthangs)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<NsLienketnhanvien>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsLienketnhanviens)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maluongcoban, e.Madonvi }).HasName("PK_Nsluongcoban");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsLuongcobans)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maluonghopdong, e.Madonvi }).HasName("PK_Nsluonghopdong");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsLuonghopdongs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maluonghopdong, e.Mabophan, e.Madonvi }).HasName("PK_NsLuonghopdongnhanvien");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsLuonghopdongbophans)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsLuonghopdongnhanvien_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsLuonghopdongbophans)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsLuonghopdongnhanvien_NsBophan");

            entity.HasOne(d => d.NsLuonghopdong).WithMany(p => p.NsLuonghopdongbophans)
        ...
        {
            entity.HasKey(e => new { e.Maluonghopdong, e.Manhanvien, e.Madonvi }).HasName("PK_NsLuonghopdongnhanvien_1");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsLuonghopdongnhanviens)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsLuonghopdongnhanvien_Donvi1");

            entity.HasOne(d => d.NsLuonghopdong).WithMany(p => p.NsLuonghopdongnhanviens)
                .HasForeignKey(d => new { d.Maluonghopdong, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsLuonghopdongnhanvien_NsLuonghopdong1");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsLuonghopdongnhanviens)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Mangaynghi, e.Madonvi }).HasName("PK_Nsngaynghi_1");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsNgaynghis)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsNgaynghi_Donvi");

            entity.HasOne(d => d.NsBophan).WithMany(p => p.NsNgaynghis)
                .HasForeignKey(d => new { d.Mabophan, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maphongban, e.Madonvi }).HasName("PK_Nsphongban");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsPhongbans)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maphucap, e.Madonvi }).HasName("PK_Nsphucap");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsPhucaps)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Maphucap, e.Manhanvien, e.Madonvi }).HasName("PK_Nsnhanvienphucap");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsPhucapnhanviens)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsPhucapnhanvien_Donvi");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsPhucapnhanviens)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsPhucapnhanvien_Nhanvien");

            entity.HasOne(d => d.NsPhucap).WithMany(p => p.NsPhucapnhanviens)
                .HasForeignKey(d => new { d.Maphucap, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<NsQdkhenthuongkyluat>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.NsQdkhenthuongkyluats)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NsQdkhenthuongkyluat_Donvi");

            entity.HasOne(d => d.Nhanvien).WithMany(p => p.NsQdkhenthuongkyluats)
                .HasForeignKey(d => new { d.Manhanvien, d.Madonvi })
        ...
        modelBuilder.Entity<NsQdkhenthuongkyluatct>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("NsQdkhenthuongkyluatct");
            ...
            entity.HasOne(d => d.NsQdkhenthuongkyluat).WithMany()
        ...
        modelBuilder.Entity<Phanquyenhanghoa>(entity =>
        {
            ...
            entity.HasOne(d => d.Nhomquyen).WithMany()
                .HasForeignKey(d => new { d.Manhomquyen, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Quayhang>(entity =>
        {
            ...
            entity.Property(e => e.Madonvi)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Makhoam)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Makhohang)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Makhokm)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Ngaytao)
                .HasDefaultValueSql("(getdate())")
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Quayhangs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Mactktpk).HasName("PK_Quyctkt_1");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Quyctkts)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Quyctktct>(entity =>
        {
            ...
            entity.HasOne(d => d.MactktpkNavigation).WithMany(p => p.Quyctktcts)
                .HasForeignKey(d => d.Mactktpk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Quyctktct_Quyctkt");
        });
        ...
        modelBuilder.Entity<Sodudaukybk>(entity =>
        {
            entity.HasKey(e => new { e.Thang, e.Nam, e.Matk, e.Makhachhang, e.Manhanvien, e.Makho, e.Madonvi });

            entity.ToTable("Sodudaukybk");
        ...
        modelBuilder.Entity<Sodudaukybk2020>(entity =>
        {
            entity.HasKey(e => new { e.Thang, e.Nam, e.Matk, e.Makhachhang, e.Manhanvien, e.Makho, e.Madonvi });

            entity.ToTable("Sodudaukybk2020");
        ...
        modelBuilder.Entity<SxDenghilinhlieu>(entity =>
        {
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.SxDenghilinhlieus)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Madonvi, e.Madoituongtaphop }).HasName("PK_Doituongtaphopchiphi");
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tendoituongtaphop).HasMaxLength(250);
        });
        ...
        modelBuilder.Entity<SxDmHieusuat>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Tenhieusuat).HasMaxLength(50);
        });
        ...
        modelBuilder.Entity<SxDmXacnhanct>(entity =>
        {
            ...
            entity.HasOne(d => d.SxDmXacnhan).WithMany(p => p.SxDmXacnhancts)
        ...
        modelBuilder.Entity<SxDmcongthucsxct>(entity =>
        {
            ...
            entity.HasOne(d => d.SxDmcongthucsx).WithMany(p => p.SxDmcongthucsxcts)
        ...
        modelBuilder.Entity<SxDutinhNvl>(entity =>
        {
            ...
            entity.Property(e => e.Khohang)
                .HasMaxLength(250)
                .IsUnicode(false);
            entity.Property(e => e.Loaigiaodich).HasDefaultValue(1);
            entity.Property(e => e.Magiaodichphu)
                .HasMaxLength(20)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<SxDutinhNvlct>(entity =>
        {
            ...
            entity.HasOne(d => d.SxDutinhNvl).WithMany(p => p.SxDutinhNvlcts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Masieuthi, e.Madonvi }).HasName("PK_SxHieuSuatSanPham_1");
        ...
        {
            entity.HasKey(e => new { e.Magiaodichpk, e.Madonvi }).HasName("PK_SxKehoach_1");
        ...
        modelBuilder.Entity<SxKehoachct>(entity =>
        {
            ...
            entity.HasOne(d => d.SxKehoach).WithMany(p => p.SxKehoachcts)
                .HasForeignKey(d => new { d.Magiaodichpk, d.Madonvi })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SxKygiathanh>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Trangthai).HasDefaultValue(10);
            entity.Property(e => e.Tungay).HasColumnType("datetime");
        });

        modelBuilder.Entity<SxKygiathanhct>(entity =>
        {
            entity.HasKey(e => new { e.Madonvi, e.Ma, e.Madoituongtaphop }).HasName("PK_SxDodangcuoikyct");
            ...
            entity.HasOne(d => d.SxKygiathanh).WithMany(p => p.SxKygiathanhcts)
        ...
        modelBuilder.Entity<SxNvXacnhan>(entity =>
        {
            ...
            entity.HasOne(d => d.SxDmXacnhan).WithMany(p => p.SxNvXacnhans)
                .HasForeignKey(d => new { d.Maxacnhan, d.Madonvi })
        ...
        {
            entity.HasKey(e => new { e.Madonvi, e.Maky }).HasName("PK_SxPhanbochiphichung_1");
        ...
        {
            entity.HasKey(e => new { e.Madonvi, e.Maky, e.Madoituongtaphop }).HasName("PK_Sxphanbochiphichungct");
            ...
            entity.HasOne(d => d.SxKygiathanh).WithMany(p => p.SxPhanbochiphichungcts)
        ...
        modelBuilder.Entity<TsGiaodichct>(entity =>
        {
            ...
            entity.HasOne(d => d.TsGiaodich).WithMany(p => p.TsGiaodichcts)
                .HasForeignKey(d => new { d.Madonvi, d.Magiaodichpk })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TsGiaodichct_TsGiaodich");

            entity.HasOne(d => d.TsLoaitaisan).WithMany(p => p.TsGiaodichcts)
                .HasForeignKey(d => new { d.Madonvi, d.Maloaitaisan })
                .HasConstraintName("FK_TsGiaodichct_TsLoaitaisan");

            entity.HasOne(d => d.TsNhomtaisan).WithMany(p => p.TsGiaodichcts)
                .HasForeignKey(d => new { d.Madonvi, d.Manhomtaisan })
                .HasConstraintName("FK_TsGiaodichct_TsNhomtaisan");

            entity.HasOne(d => d.TsTaisan).WithMany(p => p.TsGiaodichcts)
        ...
        modelBuilder.Entity<TsKhauhaoct>(entity =>
        {
            ...
            entity.HasOne(d => d.TsKhauhao).WithMany(p => p.TsKhauhaocts)
                .HasForeignKey(d => new { d.Madonvi, d.Magiaodichpk })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TsKhauhaoct_TsKhauhao");

            entity.HasOne(d => d.TsTaisan).WithMany(p => p.TsKhauhaocts)
                .HasForeignKey(d => new { d.Madonvi, d.Mataisan })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<TsNhomtaisan>(entity =>
        {
            ...
            entity.HasOne(d => d.TsLoaitaisan).WithMany(p => p.TsNhomtaisans)
                .HasForeignKey(d => new { d.Madonvi, d.Maloaitaisan })
                .HasConstraintName("FK_TsNhomtaisan_TsLoaitaisan");
        });
        ...
        modelBuilder.Entity<TsTaisan>(entity =>
        {
            ...
            entity.HasOne(d => d.TsLoaitaisan).WithMany(p => p.TsTaisans)
                .HasForeignKey(d => new { d.Madonvi, d.Maloaitaisan })
                .HasConstraintName("FK_TsTaisan_TsLoaitaisan");

            entity.HasOne(d => d.TsNhomtaisan).WithMany(p => p.TsTaisans)
                .HasForeignKey(d => new { d.Madonvi, d.Manhomtaisan })
                .HasConstraintName("FK_TsTaisan_TsNhomtaisan");
        });
        ...
        modelBuilder.Entity<Tuyenduong>(entity =>
        {
            ...
            entity.Property(e => e.Tentuyen).HasMaxLength(200);
        });
        ...
        modelBuilder.Entity<VSxTonghopnhapthanhpham>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("V_SX_TONGHOPNHAPTHANHPHAM");
        ...
        modelBuilder.Entity<VXdTonghopcongviecphatsinh>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("V_XD_TONGHOPCONGVIECPHATSINH");
        ...
        modelBuilder.Entity<VXdTonghopnhapvtcongtrinh>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("V_XD_TONGHOPNHAPVTCONGTRINH");
        ...
        modelBuilder.Entity<VXdTonghopnhapvtthicong>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("V_XD_TONGHOPNHAPVTTHICONG");
        ...
        modelBuilder.Entity<VXdTonghopvattucongtrinh>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("V_XD_TONGHOPVATTUCONGTRINH");
        ...
        modelBuilder.Entity<VXdTonghopvattuphatsinh>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("V_XD_TONGHOPVATTUPHATSINH");
        ...
        modelBuilder.Entity<VtGiaodichthuexe>(entity =>
        {
            ...
            entity.Property(e => e.Tendangnhapsua)
                ...
                .IsUnicode(false);
            entity.Property(e => e.Tungay).HasColumnType("datetime");
            entity.Property(e => e.Tuyenduong).HasMaxLength(500);
        });
        ...
        {
            entity.HasKey(e => new { e.Maxe, e.Madonvi }).HasName("PK_VtVaynganhang_1");
        ...
        {
            entity.HasKey(e => new { e.Mavuviec, e.Madonvi }).HasName("PK_vuviec");
            ...
            entity.HasOne(d => d.MadonviNavigation).WithMany(p => p.Vuviecs)
                .HasForeignKey(d => d.Madonvi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Vuviec_Donvi");

            entity.HasOne(d => d.Nhomvuviec).WithMany(p => p.Vuviecs)
        ...
        modelBuilder.Entity<Xnt13062020>(entity =>
        {
            entity.HasKey(e => new { e.Makhohang, e.Madonvi, e.Masieuthi }).HasName("PK_XNT_13062020_1");

            entity.ToTable("XNT_13062020");
        ...
        modelBuilder.Entity<Xnt14062020>(entity =>
        {
            entity.HasKey(e => new { e.Makhohang, e.Madonvi, e.Masieuthi }).HasName("PK_XNT_14062020_1");

            entity.ToTable("XNT_14062020");
        ...
        modelBuilder.Entity<Xnt15062020>(entity =>
        {
            entity.HasKey(e => new { e.Makhohang, e.Madonvi, e.Masieuthi }).HasName("PK_XNT_15062020_1");

            entity.ToTable("XNT_15062020");
        ...
        modelBuilder.Entity<Xnt16062020>(entity =>
        {
            entity.HasKey(e => new { e.Makhohang, e.Madonvi, e.Masieuthi }).HasName("PK_XNT_16062020_1");

            entity.ToTable("XNT_16062020");
        ...
        modelBuilder.Entity<XntGiavondk>(entity =>
        {
            entity.HasKey(e => new { e.Makhohang, e.Madonvi, e.Masieuthi });

            entity.ToTable("XNT_GIAVONDK");
